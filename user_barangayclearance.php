...
include 'API/API_getQRpayment2.php';
?>
    ...
    <div class="container" style="padding-top: 108px !important; ">
        ...
        <div class="column" style ="margin-top: 5px; display:inline-block">
                ...
                <div class = "column" style="border:solid; padding: 1%">
                    <h1 style="text-align:left">Barangay Clearance</h1>
                    <h4>Barangay Clearance is a requirement before the municipality issues any license for the business or activity. The barangay clearance is obtained from the barangay where the intended business of activity is located or conducted.</h4>
                </div>
            </div><br>
      
            <div class="profile-container" style=" margin: auto;background-color: #659DBD;padding:30px;border-radius:10px;">
            <label id="tab" for="#holder">Barangay Clearance Application</label>
                <div class="row row-space-20">
                    <div class="col-md-12">
                        ...
                        <div style="font-style:italic;"><h5>*Some important information are gathered from the personal information of the user*</h5></div>
                            ...
                            <input  type ="number" style = " margin-bottom: 10px" name="doc_Age" class="form-control" id="profdoc_Age_Fathername" minlength="4" required placeholder="Enter Age" >
                           ...
                           <label for="Valid_ID1">Tax certificate or Cedula copy<span>*</span></label>
                            ...
                            <label for="doc_UploadedID">Upload ID<span>*</span></label>
                            ...
                            <input class="btn btn-success" type="submit" name="submit_brg_clear" id="submit_brg_clear" value="Submit" style="margin-top:100px; padding:10px"/>
                        </form>
                        </div>
                    </div>
                </div>
