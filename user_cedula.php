...
include 'API/API_getQRpayment5.php';
?>
            ...
            <label id="tab" for="#holder">Cedula Application</label>
                <div class="row row-space-20">
                    ...
                    <form action = "API/API_barangay_document.php" method="POST" enctype='multipart/form-data'>        
                            ...
                            <label for="reason">Birth Place<span>*</span></label>
                            <input  style = "  margin-bottom: 10px" name="doc_Birthplace" class="form-control" id="doc_Birthplace" minlength="4" required placeholder="Enter Birth Place"> 
                            ...
                            <label for="reason">Age<span>*</span></label>
                            <input  type = "number" style = "  margin-bottom: 10px" name="doc_Age" class="form-control" id="doc_Age" minlength="4" required placeholder="Enter Age" >  
                            <label for="reason">Height<span>*</span></label>
                            <input  type = "number" style = "  margin-bottom: 10px" name="doc_Height" class="form-control" id="doc_Height" minlength="3" min = "137 cm" required placeholder="Enter Height in cm"> 
                            <label for="reason">Weight<span>*</span></label>
                            <input type = "number" style = "  margin-bottom: 10px" name="doc_Weight" class="form-control" id="doc_Weight" minlength="2" min="28 kg" required placeholder="Enter Weight in kg"> 
                            <label for="reason">Occupation<span>*</span></label>
                            <input  style = "  margin-bottom: 10px" name="doc_Occupation" class="form-control" id="doc_Occupation" minlength="4" required placeholder="Enter Occupation">  
                            ...
                            <label for="reason">Total Earning From Salaries Profession</label>
                            <input type = "number" style = "  margin-bottom: 10px" name="doc_Earningfromsal" class="form-control" id="doc_Earningfromsal" minlength="4" placeholder="Enter Total Earning From Salaries Profession" >  
                            <label for="reason">Total Gross Receipt From Business</label>
                            <input  type = "number" style = "  margin-bottom: 10px" name="doc_Grossrecfrombus" class="form-control" id="doc_Grossrecfrombus" minlength="4"  placeholder="Enter Total Gross Receipt From Business">  
                            <label for="reason">Total Income From Party</label>
                            <input type = "number"  style = "  margin-bottom: 10px" name="doc_Totalincom" class="form-control" id="doc_Totalincom" minlength="4" placeholder="Enter Total Income From Party" >
                            <label for="reason">Tax Identification Number</label>
                            <input  style = "  margin-bottom: 10px" name="doc_Taxindentification" class="form-control" id="doc_Taxindentification" minlength="4" placeholder="Enter Tax Indentification Number" >    
                            ...
                            <input class="btn btn-success" type="submit" name="submit_Cedula" id="submit_Cedula" value="Submit" style="margin-top:100px; padding:10px"/>
                    </form>
                        </div>
                    </div>
                </div>
