            ...
            <body>
                ...
                <div id="receipt_body">
                    <label>Transaction ID: <span>BaRIS-transac_1653991255</span></label>
                    <hr><br>
                    <label>Document ID: <span>BaRISPost_6294dbb380da2</span></label>
                    <hr><br>
                    <label>Requested Document: <span>Barangay_Ceritificate</span></label>
                    <hr><br>
                    <label>Date: <span>05-30-2022 </span></label>
                    <hr><br>
