            ...
            <body>
                ...
                <div id="receipt_body">
                    <label>Transaction ID: <span>BaRIS-transac_1653998651</span></label>
                    <hr><br>
                    <label>Document ID: <span>BaRISPost_629603a4b7ec7</span></label>
                    <hr><br>
                    <label>Requested Document: <span>Barangay_Ceritificate</span></label>
                    <hr><br>
