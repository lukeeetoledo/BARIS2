      ...
      if($doc_Type == "Barangay_Ceritificate") {
        ...
        <div class='container' id='Barangay_Certificate' style='border:solid; margin:20px'>
            ...
            <div class='row'>
                ...
                <div id='cedulaycpy'><span style = 'margin-right: 20px'><b>Cedula copy:<br></b></span><img width='600px' height='720' src='$doc_Cedulacpy' alt = ''/></div><hr>
                ...
                <div id='payment'><span style = 'margin-right: 20px'><b>Proof of Payment:<br></b></span><img width='600px' height='720' src='$doc_Payment' alt = ''/></div><hr>
        ...
        <div class='container' id='Barangay_Certificate' style='border:solid; margin:20px'>
            ...
            <div class='row'>
                ...
                <div id='uploadedid'><span style = 'margin-right: 20px'><b>Uploaded Id:<br></b></span><img width='600px' height='720' src='$doc_UploadedID' alt = ''/></div><hr>
                <div id='email'><span style = 'margin-right: 20px'><b>Email:</b></span> $doc_Email</div><hr>
                <div id='contact'><span style = 'margin-right: 20px'><b>Contact:</b></span> $doc_Contact</div><hr>
                <div id='payment'><span style = 'margin-right: 20px'><b>Proof of Payment:<br></b></span><img width='600px' height='720' src='$doc_Payment' alt = ''/></div><hr>
                <div id='delivertype'><span style = 'margin-right: 20px'><b>Deliver through:</b></span> $doc_DeliverType</div><hr>
        ...
        <div class='container' id='Barangay_Certificate' style='border:solid; margin:20px'>
            ...
            <div class='row'>
                ...
                <div id='idpresented'><span style = 'margin-right: 20px'><b>ID presented:</b></span> $doc_IDpres</div><hr>
                <div id='uploadedid'><span style = 'margin-right: 20px'><b>Uploaded Id:<br></b></span><img width='600px' height='720' src='$doc_UploadedID' alt = ''/></div></div><hr>
                <div id='email'><span style = 'margin-right: 20px'><b>Email:</b></span> $doc_Email</div><hr>
                <div id='contact'><span style = 'margin-right: 20px'><b>Contact:</b></span> $doc_Contact</div><hr>
