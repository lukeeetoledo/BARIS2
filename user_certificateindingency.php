    ...
    <div class="container" style="padding-top: 108px !important; ">
        ...
        <div class="column" style ="margin-top: 5px; display:inline-block">
                ...
                <div class = "column" style="border:solid; padding: 1%">
                    <h1 style="text-align:left">Certificate of Indingency</h1>
                    <h4>Certificate of Indigency is issued to less fortunate resident who desires to avail assistance such as Scholarship, Medical Services, Free Legal Aid from Public Attorney’s Office (PAO) and the like.</h4>
                </div>
            </div><br>
      
            <div class="profile-container" style=" margin: auto;background-color: #659DBD;padding:30px;border-radius:10px;">
            <label id="tab" for="#holder">Certificate of Indingency Application</label>
